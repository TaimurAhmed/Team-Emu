...
{\HUGE Software Engineering and Group Project }\\[4mm]
{\Large \textit{COMSM1401}}\\
\rule[0.5ex]{\linewidth}{1pt}\vspace*{-\baselineskip}\vspace{3.2pt}
\rule[0.5ex]{\linewidth}{2pt}\\
\vspace{6.5mm}
{\large By}\\
\vspace{6.5mm}
{\large\textsc{Team Emu}}\\
\vspace{11mm}
...
\begin{minipage}{10cm}
\begin{center}
A report submitted to the University of Bristol for the purposes of \textsc{COMSM1401} in the Faculty of Engineering.
\end{center}
\end{minipage}\\
\vspace{9mm}
{\large\textsc{TB:2 2017}}
\vspace{12mm}
\end{center}
\begin{flushright}
{\small Word count: (\hl{XXXXX})}
